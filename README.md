...
This project uses the Meteosource Weather API to fetch weather data. You can find more information and sign up for an API key at the [OpenWeatherMap API page](https://openweathermap.org/api).
...
Happy coding! If you have any questions, feel free to reach out [Email me](work.arhamkhan@gmail.com).
